...
- Feature engineering (e.g., success rate, goal ranges)  
...
- Which categories achieve the highest success rates?  
- How does funding goal impact success?  
- What is the distribution of project outcomes?  
- Which projects received the highest funding?  
- Which projects attracted the most backers?  
- How have trends evolved over time?  
- What is the relationship between goal range and success rate?  
- Which regions contribute the most projects?  
...
- Count failed and cancelled projects  
- List top 10 projects by amount raised  
- Calculate average backers per category  
- Compute success rate per category  
- Identify projects with highest backers  
- Analyze project trends over time  
- Compare success across funding goal ranges  
- Retrieve projects exceeding funding goals  
